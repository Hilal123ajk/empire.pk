...
">
        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <select x-model="sort" class="px-4 py-2 border border-gray-300 rounded-xl text-sm bg-white focus:outline-none focus:ring-2 focus:ring-empire-500">
            ...
            <aside class="hidden lg:block w-64 shrink-0">
                <div class="bg-white rounded-2xl border border-gray-200 p-5 sticky top-36 space-y-6">
                    ...
                    <div>
                        ...
                        <select x-model="category" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-empire-500">
                    ...
                    <div>
                        ...
                        <select x-model="brand" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-empire-500">
    ...
    <div x-show="mobileFiltersOpen" x-cloak class="lg:hidden fixed inset-0 z-50">
        ...
        <div class="absolute right-0 top-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-2xl overflow-y-auto p-5 space-y-5">
            ...
            <select x-model="category" class="w-full px-3 py-2 border rounded-lg text-sm">
                <option value="">All Categories</option>
                <template x-for="cat in EMPIRE_STORE.categories" :key="cat.slug">
                    <option :value="cat.slug" x-text="cat.name"></option>
                </template>
            </select>
            <select x-model="brand" class="w-full px-3 py-2 border rounded-lg text-sm">
                <option value="">All Brands</option>
                <template x-for="b in EMPIRE_STORE.brands" :key="b">
                    <option :value="b" x-text="b"></option>
                </template>
